...
input_file = r'apps\web-frontend\public\skydata\tle_satellite.jsonl'
output_file = r'apps\web-frontend\public\skydata\tle_satellite_temp.jsonl'
backup_file = r'apps\web-frontend\public\skydata\tle_satellite.jsonl.backup2'
